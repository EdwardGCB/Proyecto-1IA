...
if (isset($_GET['idEvento'])) {
    ...
    if ($evento->consultaIndividual()) {
        $eventoZona = new EventoZona(null,null,$idEvento);
          ...
          <div class="table-reservas">
            ...
            <table id="reservaAsientosTable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo $eventoZonaActual->getZona()->getNombre(); // Nombre de la zona ?></td>
                  <td><?php echo $eventoZonaActual->getEvento()->getNombre(); // Nombre del evento ?></td>
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-primary" name="emitirTicket"
                      value="<?php echo $zona->getZona(); ?>">Emitir Ticket</button>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
