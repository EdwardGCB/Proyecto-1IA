...
CREATE TABLE IF NOT EXISTS `ticketera`.`Asiento` (
  ...
  INDEX `fk_Asiento_Zona1_idx` (`Zona_idZona` ASC),
...
CREATE TABLE IF NOT EXISTS `ticketera`.`Ticket` (
  ...
  INDEX `fk_Ticket_Asiento1_idx` (`Asiento_idAsiento` ASC),
  ...
  CONSTRAINT `fk_Ticket_Asiento1`
    ...
    REFERENCES `ticketera`.`Asiento` (`idAsiento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
